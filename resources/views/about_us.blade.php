...
@section('content')
  <div class='container' style='padding-top:20px'> 
    ...
    <div>
      ...
      <p> Private independent craft shop MAŠINAC was founded in 1991. It was the beginning and continuation of the long-term blacksmithing and metal-turning tradition of our ancestors, half a century old. By constant work and monitoring the movement of world trends or areas around and screw goods, MAŠINAC was developed in a modern company that operates in three different, yet connected units.
      </p>

      <div class='row'> 
        <div class="col d-flex justify-content-between" >
          <img alt="" src="https://via.placeholder.com/300x300" >
          <img alt="" src="https://via.placeholder.com/300x300" >
          <img alt="" src="https://via.placeholder.com/300x300" >
        </div>
      </div>
